...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "OfOurOwn — the digital home of Ben Gordon, NBA legend. Training, wellness, and coaching." },
      { name: "author", content: "Ben Gordon" },
      { property: "og:site_name", content: "OfOurOwn" },
      { property: "og:title", content: "OfOurOwn— by Ben Gordon, NBA superstar" },
      { property: "og:description", content: "OfOurOwn — the digital home of Ben Gordon, NBA legend. Training, wellness, and coaching." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "OfOurOwn— by Ben Gordon, NBA superstar" },
      { name: "twitter:description", content: "OfOurOwn — the digital home of Ben Gordon, NBA legend. Training, wellness, and coaching." },
