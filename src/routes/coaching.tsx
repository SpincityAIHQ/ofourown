...
export const Route = createFileRoute("/coaching")({
  head: () => ({
    meta: [
      { title: "Coaching with Ben Gordon" },
      { name: "description", content: "1:1 coaching for athletes, founders, and operators serious about their craft." },
      { property: "og:title", content: "Coaching with Ben Gordon" },
      { property: "og:description", content: "1:1 coaching with Ben Gordon for serious performers." },
    ],
  }),
  ...
  return (
    <>
      <PageHero
        ...
        lede="A private, ongoing engagement for people whose job is to perform — athletes, founders, operators. Ben works with a small roster at a time."
      />
      <Section className="border-b border-border">
        <div className="mx-auto max-w-3xl">
          ...
          <ol className="mt-6 space-y-8 text-lg">
            ...
            <li><span className="font-display text-2xl">02 — Weekly cadence.</span> Async check-ins and a scheduled call. Ben sees the full picture: training, recovery, work, life.</li>
